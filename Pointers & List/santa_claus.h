...
extern struct present *stock_list; /* global variable which is a pointer to the beginning of the list β€�stockβ€� */
extern struct present *stock_sentinel; /* global variable of pointer to the sentinel node of the list β€�stockβ€� */
